...
export const PLATFORM_CONTEXT = {
  ...
  mcpDefinition: {
    ...
    description:
      'A protocol for providing tools, resources, and prompts to Large Language Models (LLMs)',
  ...
  purpose:
    'Automatically generate production-ready MCP servers from any input source (GitHub repos, API specs, service names, natural language descriptions)',
